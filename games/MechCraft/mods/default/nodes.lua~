...
default.pixelnodebox = function ( size, boxes )
    local fixed = { };
    local i, box;
...
minetest.register_node("default:supplypc", {
    description = "Supply PC";
    drawtype = "nodebox";
    paramtype = "light";
    paramtype2 = "facedir";
    groups = { snappy=2, choppy=2, oddly_breakable_by_hand=2 };
    tiles = {
        "computer_supplypc_tp.png",
        "computer_supplypc_bt.png",
        "computer_supplypc_rt.png",
        "computer_supplypc_lt.png",
        "computer_supplypc_bk.png",
        "computer_supplypc_ft.png",
    };
    ...
    node_box = default.pixelnodebox(32, {
        -- X   Y   Z   W   H   L
