...
minetest.register_node("snow:needles_decorated", {
	...
	paramtype = "light",
	groups = {snappy=3, leafdecay=3, flammable=2,oddly_breakable_by_hand=2,not_in_creative_inventory=1},
		drop = {
		max_items = 1,
		items = {
			{
...
minetest.register_node("snow:star", {
	...
	paramtype = "light",
	walkable = false,
	groups = {snappy=2,dig_immediate=3,not_in_creative_inventory=1},
	sounds = default.node_sound_defaults(),
})
...
minetest.register_node("snow:snow", {
	...
	--1 = Moss
	groups = {not_in_creative_inventory=1,crumbly=3,melts=3,oddly_breakable_by_hand=2},
	buildable_to = true,
	drop = 'snow:snowball',
	node_box = {
		type = "fixed",
...
minetest.register_node("snow:snow_block", {
	...
	--3 = Dry shrub
	is_ground_content = true,
	groups = {not_in_creative_inventory=1,crumbly=3,melts=2,falling_node=1},
		...
		action = function(pos, node, active_object_count, active_object_count_wider)
			...
			if in_biome then
				...
				if ground_y then
					...
					if (n.name ~= "snow:snow" and n.name ~= "snow:snow_block" and n.name ~= "default:ice" and n.name ~= "default:water_source" and n.name ~= "default:papyrus") then
