...
function tabbuilder.dialog_create_world()
	local mapgens = {"Default", "v7", "In-dev", "uNode", "Math"}
...
function tabbuilder.tab_multiplayer()
	...
	local retval =
		"vertlabel[0,-0.25;".. fgettext("JOIN SERVER") .. "]" ..
...
function tabbuilder.tab_singleplayer()
	...
	return	"button[4,4.15;3.8.,0.5;world_delete;".. fgettext("Delete") .. "]" ..
			"button[7.9,4.15;3.8,0.5;world_create;".. fgettext("New") .. "]" ..
			--"button[9.2,4.15;2.55,0.5;world_configure;".. fgettext("Configure") .. "]" ..
...
function tabbuilder.tab_credits()
	...
	return	"vertlabel[0,-0.5;ABOUT]" ..
			"label[0.5,2;Reign of Darkness]" ..
			"label[0.5,2.3;Developer Preview]" ..
			"label[0.5,2.6;By Conno123009]" ..
			"image[0.5,1;" .. engine.formspec_escape(logofile) .. "]" ..
			"label[3.5,-0.25;8.5,5.8;Based off the game MineTest]" ..
			"textlist[3.5,-0.25;8.5,5.8;list_credits;" ..
			"#FFFF00" .. fgettext("Reign of Darkness Developers") .."," ..
			"Conno123009 <Conno123009@programmer.net>,"..
			"Jack Fitzpatrick <jackowenfitzpatrick@gmail.com>,"..
			"Luke Azar <thelazar42@gmail.com>," ..
			"#FFFF00" .. fgettext("MineTest Current and Past Developers") .."," ..
			...
			","..
			"Someone actually read the credits! YEAH!"..
			";0;true]"
end
...
function tabbuilder.init()
	...
	table.insert(tabbuilder.current_buttons,{name="multiplayer", caption=fgettext("Join")})
	table.insert(tabbuilder.current_buttons,{name="server", caption=fgettext("Host")})
	table.insert(tabbuilder.current_buttons,{name="settings", caption=fgettext("Options")})
	table.insert(tabbuilder.current_buttons,{name="texture_packs", caption=fgettext("Textures")})
